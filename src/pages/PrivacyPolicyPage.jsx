...
export default function PrivacyPolicy() {
    return (
        <div className="w-3/4 mx-auto py-10">
            ...
            <h2 className="mt-5 text-xl font-bold">Types of Data Collected</h2>
            <h3 className="mt-5 text-l font-bold">Personal Data</h3>
            <p>
            ...
            <h3 className="mt-5 text-l font-bold">Usage Data</h3>
            ...
            <h3 className="mt-5 text-l font-bold">
            ...
            <h3 className="mt-5 text-l font-bold">Business Transactions</h3>
            <p>
            ...
            <h3 className="mt-5 text-l font-bold">Law enforcement</h3>
            <p>
            ...
            <h3 className="mt-5 text-l font-bold">Other legal requirements</h3>
            <p>
