...
export default function TermsOfService() {
    return (
        <div className="w-3/4 mx-auto py-10">
            ...
            <h2 className="mt-5 text-xl font-bold">Interpretation</h2>
            <p>
            ...
            <h2 className="mt-5 text-xl font-bold">Definitions</h2>
            ...
            <ul>
                ...
                <li className="mt-2">
                    <p>
                        ...
                        the&nbsp;
                        <Link
                            to="https://www.termsfeed.com/terms-conditions-generator/"
                            target="_blank"
                        >
                ...
                <li className="mt-2">
                    <p>
                        <strong>Website</strong> refers to CoderKit, accessible
                        from&nbsp;
                        <Link
                            to="https://coderkit.dev"
            ...
            <h1 className="mt-10 text-2xl font-bold">Acknowledgment</h1>
            <p>
            ...
            <h1 className="mt-10 text-2xl font-bold">Termination</h1>
            <p>
            ...
            <h1 className="mt-10 text-2xl font-bold">Governing Law</h1>
            <p>
            ...
            <h1 className="mt-10 text-2xl font-bold">Disputes Resolution</h1>
            <p>
            ...
            <h2 className="mt-5 text-xl font-bold">Severability</h2>
            <p>
            ...
            <h2 className="mt-5 text-xl font-bold">Waiver</h2>
            <p>
            ...
            <ul>
                <li className="mt-2">
                    ...
                    <Link
                        to="https://coderkit.dev/feedback"
                        rel="external nofollow noopener"
                        target="_blank"
                    >
                        https://coderkit.dev/feedback
                    </Link>
                </li>
            </ul>
        </div>
